...
test('TC_SSG_FORMULA - Nhập điểm số cho HS chỉ định để kiểm tra công thức HK1/HK2/CN - Điểm số ', async ({ page }) => {
  await page.goto('/');
...
test('TC_SSG_FORMULA - Nhập điểm chữ cho HS chỉ định để kiểm tra công thức HK1/HK2/CN - Điểm chữ', async ({ page }) => {
  await page.goto('/');
  await loginAndNavigate(page);
...
test('TC_SSG_FORMULA - Nhập điểm số cho HS chỉ định để kiểm tra công thức HK1/HK2/CN - Tiểu học - Điểm số', async ({ page }) => {
  await page.goto('/');
  await loginAndNavigate(page);
...
test('TC_SSG_FORMULA - Nhập điểm chữ cho HS chỉ định để kiểm tra công thức HK1/HK2/CN - Tiểu học điểm chữ', async ({ page }) => {
  await page.goto('/');
  await loginAndNavigate(page);
